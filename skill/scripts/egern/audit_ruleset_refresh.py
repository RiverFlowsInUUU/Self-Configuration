...
用法
----
    python audit_ruleset_refresh.py egern/profiles/routing_v3.1.yaml
    python audit_ruleset_refresh.py egern/profiles/routing_v3.1.yaml egern/profiles/lazy.yaml --strict
